...
# In case you need to re-install the Ceph Cluster, make sure to reinitialize the disk
...
sleep 3
oc wait --for=condition=Ready --timeout=10m pod -l app=rook-ceph-tools -n openshift-storage
