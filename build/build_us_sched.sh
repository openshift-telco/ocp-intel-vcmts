...
IS_RHEL_BUILD=y
VCMTSD_HOST=y
IMAGE_NAME=${REGISTRY_URL}/vcmts-us-sched
...
mkdir ${VCMTS_ROOT}/src/app/us-sched/container/us-sched-config
cp ${VCMTS_ROOT}/tools/vcmts-env/*.sh ${VCMTS_ROOT}/src/app/us-sched/container/us-sched-config
